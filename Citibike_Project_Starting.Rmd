...
# Create a heatmap
citibike_heatmap <- ggplot(all_data, aes(x=start.station.longitude, y=start.station.latitude)) + geom_bin2d(binwidth=c(0.001, 0.001))
citibike_heatmap
...
# Getting the starting and ending latitude and longitudes
...
average_speed_by_age %>% ggplot() + geom_line(aes(x = age, y = mean_speed)) + labs(title = "Average speed of Citi Bike users by age (January 2020)", x = "Age", y = "Average Speed (m/s)") + theme(plot.title = element_text(hjust = 0.5))
...
average_speed_by_age_and_gender %>% filter(age < 80) %>% ggplot() + geom_line(aes(x = age, y = mean_speed, color = gender)) + labs(title = "Average speed of Citi Bike users by age (January 2020)", x = "Age", y = "Average Speed (m/s)") + theme(plot.title = element_text(hjust = 0.5))
...
average_speed_by_age_and_gender %>% filter(age < 80, gender == 1 | gender == 2) %>% ggplot() + geom_line(aes(x = age, y = mean_speed, color = gender)) + labs(title = "Average speed of Citi Bike users by age (January 2020)", x = "Age", y = "Average Speed (m/s)") + theme(plot.title = element_text(hjust = 0.5)) + scale_color_discrete(name = "Gender", labels = c("Male Identifying", "Female Identifying"))
...
age_counts %>% filter(age < 80, gender == 1 | gender == 2) %>% ggplot(aes(x = age, y = n, fill = as.factor(gender))) + geom_col() + labs(title = "Citi Bike Users By Age And Gender", x = "Age", y = "Count") + theme(plot.title = element_text(hjust = 0.5)) + scale_fill_discrete(name="Gender", labels = c("Male Identifying","Female Identifying"))
